...
# operating system:  Linux 3.2.0-23-generic x86_64 [ELF] (3.2.0)
# libc:	(6.15.0)
# binutils:	(222)
...
install_base::
	...
	for i in $(SUBDIRS_BASE) ;\
	do \
		echo "installing base" "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  install_base; \
	done
...
batch::
	...
	for i in $(SUBDIRS_B) ;\
	do \
		echo "making batch executables" "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  batch; \
	done
...
install_b::
	...
	for i in $(SUBDIRS_B) ;\
	do \
		echo "installing batch" "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  install_b; \
	done
...
display_wx::
	...
	for i in $(SUBDIRS_WX) ;\
	do \
		echo "making executables for binwx"display_wx "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  display_wx; \
	done
...
install_wx::
	...
	for i in $(SUBDIRS_WX) ;\
	do \
		echo "installing display_wx" "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  install_wx; \
	done
...
display_x::
	...
	for i in $(SUBDIRS_X) ;\
	do \
		echo "making executables for binx"display_x "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  display_x; \
	done
...
install_x::
	...
	for i in $(SUBDIRS_X) ;\
	do \
		echo "installing display_x" "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  install_x; \
	done
...
cleanmk::
	...
	for i in $(SUBDIRS) ;\
	do \
		echo "cleaning Makefile" "in $(CURRENT_DIR)/$$i..."; \
		$(MAKE) -C $$i $(MFLAGS) $(PARALLELMFLAGS)  cleanmk; \
	done
